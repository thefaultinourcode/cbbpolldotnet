...
export default function Season(props) {
	...
	links3.push(<li><Link href={`./2025/18`}>18</Link></li>);
	links3.push(<li><Link href={`./2025/19`}>19</Link></li>);
	links3.push(<li><Link href={`./2025/20`}>20</Link></li>);
	...
	links4.push(<li><Link href={`./2026/5`}>5</Link></li>)
	links4.push(<li><Link href={`./2026/6`}>6</Link></li>)
	links4.push(<li><Link href={`./2026/7`}>7</Link></li>)
	links4.push(<li><Link href={`./2026/8`}>8</Link></li>)
	links4.push(<li><Link href={`./2026/9`}>9</Link></li>)
	links4.push(<li><Link href={`./2026/10`}>10</Link></li>)
	links4.push(<li><Link href={`./2026/11`}>11</Link></li>)
	links4.push(<li><Link href={`./2026/12`}>12</Link></li>)
	links4.push(<li><Link href={`./2026/13`}>13</Link></li>)
	links4.push(<li><Link href={`./2026/14`}>14</Link></li>)
	links4.push(<li><Link href={`./2026/15`}>15</Link></li>)
	links4.push(<li><Link href={`./2026/16`}>16</Link></li>)
	links4.push(<li><Link href={`./2026/17`}>17</Link></li>)
	links4.push(<li><Link href={`./2026/18`}>18</Link></li>)
	links4.push(<li><Link href={`./2026/19`}>19</Link></li>)
	links4.push(<li><Link href={`./2026/20`}>20</Link></li>)


	return (
		<div>
			<h1>2026 Results</h1>
			<o>{links4.map((link) => link)}</o>
			<h1>2025 Results</h1>
