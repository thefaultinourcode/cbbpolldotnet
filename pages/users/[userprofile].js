...
export default function UserProfile(props) {
	...
	if (profileData.pollVoter) {
		...
		verified = (
			<Image
				src="/static/OfficialVoterCheckmark.png"
				alt="Official Voter Checkmark"
				width={40}
				height={40}
			></Image>
		);
	...
	if (secondaryTeam && tertiaryTeam) {
		alsoSupports = (
			<h2>
				...
				<Image src={tertiaryTeam.url} width={30} height={30}></Image>
			</h2>
		);
	...
	return (
		...
		<div>
			{navbar}
			<h1>
				{verified} <Image src={primaryTeam.url} width={40} height={40}></Image>{" "}
				{profile.userprofile}
			</h1>
			{alsoSupports}
