...
export default function Application({user, teams, app, ballot, userTeams}){
    ...
    let closeDate = new Date(Date.UTC(2023, 9, 29, 3, 59));
                        ...
                        <div id="partTwo" ref={partTwo} style={{display: show?"block":"none"}}>
                            ...
                            <table className="ballotTable">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange} presetTeam={ballot['1'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning1" className="reasoning" defaultValue={ballot['1'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange2}  presetTeam={ballot['2'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning2" className="reasoning" defaultValue={ballot['2'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange3}  presetTeam={ballot['3'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning3" className="reasoning" defaultValue={ballot['3'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange4}  presetTeam={ballot['4'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning4" className="reasoning" defaultValue={ballot['4'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange5}  presetTeam={ballot['5'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning5" className="reasoning" defaultValue={ballot['5'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>6</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange6}  presetTeam={ballot['6'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning6" className="reasoning" defaultValue={ballot['6'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>7</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange7}  presetTeam={ballot['7'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning7" className="reasoning" defaultValue={ballot['7'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>8</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange8}  presetTeam={ballot['8'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning8"className="reasoning" defaultValue={ballot['8'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>9</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange9}  presetTeam={ballot['9'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning9" className="reasoning" defaultValue={ballot['9'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>10</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange10}  presetTeam={ballot['10'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning10" className="reasoning" defaultValue={ballot['10'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>11</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange11}  presetTeam={ballot['11'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning11" className="reasoning" defaultValue={ballot['11'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>12</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange12}  presetTeam={ballot['12'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning12" className="reasoning" defaultValue={ballot['12'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>13</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange13}  presetTeam={ballot['13'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning13" className="reasoning" defaultValue={ballot['13'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>14</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange14}  presetTeam={ballot['14'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning14" className="reasoning" defaultValue={ballot['14'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>15</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange15}  presetTeam={ballot['15'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning15" className="reasoning" defaultValue={ballot['15'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>16</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange16}  presetTeam={ballot['16'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning16" className="reasoning" defaultValue={ballot['16'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>17</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange17}  presetTeam={ballot['17'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning17" className="reasoning" defaultValue={ballot['17'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>18</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange18}  presetTeam={ballot['18'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning18" className="reasoning" defaultValue={ballot['18'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>19</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange19}  presetTeam={ballot['19'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning19" className="reasoning" defaultValue={ballot['19'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>20</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange20}  presetTeam={ballot['20'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning20" className="reasoning" defaultValue={ballot['20'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>21</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange21}  presetTeam={ballot['21'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning21" className="reasoning" defaultValue={ballot['21'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>22</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange22}  presetTeam={ballot['22'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning22" className="reasoning" defaultValue={ballot['22'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>23</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange23}  presetTeam={ballot['23'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning23" className="reasoning" defaultValue={ballot['23'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>24</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange24}  presetTeam={ballot['24'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning24" className="reasoning" defaultValue={ballot['24'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                    <tr>
                                        <td>25</td>
                                        <td><TeamDropdown teams={teams} change={handleBallotChange25}  presetTeam={ballot['25'].id}></TeamDropdown></td>
                                        <td><input type="textbox" id="reasoning25" className="reasoning" defaultValue={ballot['25'].reasoning} maxLength={200}></input></td>
                                    </tr>
                                </tbody>
                            </table>
                            <div className="errorMsg">{errorBallot}</div>
